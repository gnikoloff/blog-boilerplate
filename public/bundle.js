...
"use strict";
/* WEBPACK VAR INJECTION */(function(module, process) {var __WEBPACK_AMD_DEFINE_RESULT__;
...
var editableEls = document.querySelector('.editable');
var editor = new _mediumEditor2.default(editableEls, {
...
var pageCount = parseInt(getParameterByName('page')) + 1 || 2;
var pagination = document.querySelector('.pagination-container');

if (pagination) {
    var chosenItem = pagination.querySelector('ul li:nth-of-type(' + pageCount + ') span');
